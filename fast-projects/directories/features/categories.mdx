...
If you want to refresh the categories, you can run `php artisan migrate:fresh --seed` command which will reset the database and add the categories from the seeder file.
